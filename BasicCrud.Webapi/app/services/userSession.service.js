...
var UserSessionService = (function () {
    ...
    UserSessionService.prototype.getUserToken = function () {
        return localStorage.getItem('currentUser');
    };
    // Remove session
    UserSessionService.prototype.removeUserToken = function () {
        localStorage.clear();
    };
    // Save a token in the local storage
    UserSessionService.prototype.saveUserToken = function (token) {
        if (token != null || token != "") {
